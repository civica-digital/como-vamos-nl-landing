...
if (document.getElementById('survey')) React.render(React.createElement(Survey, null), document.getElementById('survey'));"use strict";
...
var Resume = (function (_React$Component) {
  ...
  _createClass(Resume, [{
    key: "render",
    value: function render() {
      return React.createElement("div", { className: "ProfileOverview" }, React.createElement("div", { className: "container" }, React.createElement("header", null, React.createElement("h1", { className: "ProfileOverview__title" }, this.props.title), React.createElement("p", { className: "ProfileOverview__description" }, this.props.description))), React.createElement("div", { className: "submit-section" }, React.createElement(Button, { label: this.props.label, action: this.props.action })));
    }
  }]);
...
var ActionComponent = (function (_React$Component) {
  ...
  function ActionComponent(props) {
    ...
    _get(Object.getPrototypeOf(ActionComponent.prototype), "constructor", this).call(this, props);
  }

  _createClass(ActionComponent, [{
    key: "render",
    value: function render() {
      return React.createElement("div", { className: "ActionComponent" }, React.createElement("div", { className: "ActionComponent__index" }, this.props.index), React.createElement("div", { className: "ActionComponent__group" }, React.createElement("label", { className: "ActionComponent__title" }, this.props.title), React.createElement("p", { className: "ActionComponent__description" }, this.props.description)));
    }
  }]);
...
var ActionComponentsGroup = (function (_React$Component2) {
  _inherits(ActionComponentsGroup, _React$Component2);

  function ActionComponentsGroup(props) {
    _classCallCheck(this, ActionComponentsGroup);

    _get(Object.getPrototypeOf(ActionComponentsGroup.prototype), "constructor", this).call(this, props);
  }

  _createClass(ActionComponentsGroup, [{
    key: "render",
    value: function render() {
      var actionComponents = this.props.components.map(function (component, index) {
      ...
      return React.createElement("div", { className: "ActionComponents" }, React.createElement("h1", null, this.props.title), actionComponents);
    }
  }]);

  return ActionComponentsGroup;
})(React.Component);"use strict";
...
var Description = (function (_React$Component) {
  ...
  _createClass(Description, [{
    key: "render",
    value: function render() {
      return React.createElement("div", { className: "SectionText" }, React.createElement("h1", { className: "SectionText__title" }, this.props.title), React.createElement("p", { className: "SectionText__description" }, this.props.description));
    }
  }]);
...
var RelatedOrganizations = (function (_React$Component) {
  _inherits(RelatedOrganizations, _React$Component);

  function RelatedOrganizations(props) {
    _classCallCheck(this, RelatedOrganizations);

    _get(Object.getPrototypeOf(RelatedOrganizations.prototype), "constructor", this).call(this, props);
  }

  _createClass(RelatedOrganizations, [{
    key: "render",
    value: function render() {
      return React.createElement("div", { className: "relatedOrganizations" }, React.createElement("h1", { className: "relatedOrganizations__title" }, this.props.title), React.createElement(ProjectGroup, { projects: this.props.items }));
    }
  }]);
...
var SuscriptionMail = (function (_React$Component) {
  _inherits(SuscriptionMail, _React$Component);

  function SuscriptionMail(props) {
    _classCallCheck(this, SuscriptionMail);

    _get(Object.getPrototypeOf(SuscriptionMail.prototype), "constructor", this).call(this, props);
  }

  _createClass(SuscriptionMail, [{
    key: "render",
    value: function render() {
      return React.createElement("div", { className: "SuscriptionMail" }, React.createElement("h1", { className: "SuscriptionMail__title" }, this.props.title), React.createElement("div", { className: "SuscriptionMail__form" }, React.createElement("form", null, React.createElement("input", { type: "email", placeholder: this.props.placeholder }), React.createElement("button", { onClick: this.props.buttonAction }, this.props.buttonMsg))));
    }
  }]);

  return SuscriptionMail;
})(React.Component);'use strict';
